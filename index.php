...
// Uncomment the following lines to clear session data if necessary
// session_unset();
// session_destroy();
// session_start();
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn-delete'])) {
    ...
    if (isset($_SESSION['data_barang'][$index])) {
        ...
        <div class="form-container">
            ...
            <form method="post" class="add-data d-flex justify-content-center flex-column mb-2">
                ...
                <div class="btn-collapse mt-2">
                    ...
                    <a href="bayar.php" class="btn btn-success" type="submit"><i class="bi bi-cart-fill"></i> CheckOut</a>
                </div>
                <!-- End Add Btn -->
            </form>
        </div>
            ...
            <tbody class="table-group-divider">
                ...
                <tr>
                    ...
                    <td class="text-center fw-bold">
                        <?php
                        $totalBarang = 0;
                        if (is_array($_SESSION["data_barang"])) {
